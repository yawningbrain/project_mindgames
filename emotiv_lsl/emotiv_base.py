...
class EmotivBase:
    ...
    def __init__(self):
        ...
        self.logger = setup_logger(
            name=self.__class__.__name__, level=LOG_LEVEL, log_file=LOG_FILE if LOG_FILE else None
        )
    ...
    def main_loop(self):
        ...
        try:
            ...
            self.logger.info(
                f"Session completed. Packets processed: {packet_count}, Errors: {error_count}"
            )
